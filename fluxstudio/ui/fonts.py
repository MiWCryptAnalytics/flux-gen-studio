...
changes — the desktop's chosen point size is kept, and HiDPI scaling
(scaling.py) multiplies it afterwards. Regular, SemiBold and Bold faces cover
everything the stylesheet asks for (weights 400/600/700). Same bundle as
Voice Design Studio.
"""
...
def install_application_font(app) -> str | None:
    ...
    error. Call right after the QApplication exists, before scaling and before
    the stylesheet is built (both read the application font).
    """
    loaded: set[str] = set()
